...
public sealed class AuraCecilCodeGenerator
{
        ...
        string? assemblyName = null, string? sourceFilePath = null)
    {
        ...
        // v5: Emit Aura base types and builder types
        AuraRuntimeEmitter.EmitFuncArgsBase(module, auraModule, userTypes);
        ...
        // Room
        AuraRuntimeEmitter.EmitRoom(module, auraModule, userTypes);
        AuraRuntimeEmitter.EmitRoomArgs(module, auraModule, userTypes);
        AuraRuntimeEmitter.EmitRoomBuilder(module, auraModule, userTypes);
